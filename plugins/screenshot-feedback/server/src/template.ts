import type { FeedbackInput } from './validators.js';
import type { FeedbackSubmitter } from './types.js';
...
export function renderFeedbackEmail(args: {
  payload: FeedbackInput;
  submitter?: FeedbackSubmitter;
  receivedAt: Date;
}): { html: string; text: string } {
  const { payload, submitter, receivedAt } = args;
