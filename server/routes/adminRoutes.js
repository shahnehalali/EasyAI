...
const { createFrameworkSchema, createRequirementSchema, createTemplateSchema, resolveReportSchema } = require('../validators/adminValidator');
...
// Community moderation queue (platform_admin only).
router.get('/reports', asyncHandler(ctrl.listReports));
router.post('/reports/resolve', validate(resolveReportSchema), asyncHandler(ctrl.resolveReport));
