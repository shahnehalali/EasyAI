    ...
    items: [
      {
        ...
        a: {
          en: 'Compliance Check helps companies in Germany meet the rules for using AI. It turns EU and German law into plain-language checklists you can work through, document, and keep reviewed each year.',
          de: 'Compliance Check hilft Unternehmen in Deutschland, die Regeln für den Einsatz von KI einzuhalten. Es übersetzt EU- und deutsches Recht in verständliche Checklisten, die Sie abarbeiten, dokumentieren und jährlich prüfen können.',
        },
      },
      {
        id: 'first-steps',
        ...
        a: {
          en: 'Register an AI system, answer a short questionnaire to classify its risk, and Compliance Check builds the right checklists for you. Then work through each item and record your evidence.',
          de: 'Legen Sie ein KI-System an, beantworten Sie einen kurzen Fragebogen zur Risikoeinstufung, und Compliance Check erstellt die passenden Checklisten für Sie. Arbeiten Sie dann jeden Punkt durch und halten Sie Ihre Nachweise fest.',
        },
      },
      {
        id: 'is-legal-advice',
        ...
        a: {
          en: 'No. Compliance Check gives plain-language guidance for orientation only. For binding interpretation of the law, consult a qualified lawyer.',
          de: 'Nein. Compliance Check bietet verständliche Hinweise nur zur Orientierung. Für eine verbindliche Auslegung des Rechts wenden Sie sich an eine qualifizierte Anwältin oder einen qualifizierten Anwalt.',
        },
      },
    ],
  },
